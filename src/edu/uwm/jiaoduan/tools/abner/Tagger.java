...
public class Tagger {
    ...
    /** the tagger trained on the i2b2 2009 discharge corpus */
    public static final int I2B22009 = 2;
...
//	    		modelPath));
    ...
    */
	...
	Vector<String[][]> tagged = doTheTagging(text);
     ...
     */
    public  Vector<String[][]> getSegments(String text) {
	Vector<String[][]> myList = new Vector<String[][]>();
	Vector<String[][]> tagged = doTheTagging(text);
...
//	String tag = "";
    ...
    private  Vector<String[][]> doTheTagging(String text) {
	...
	if (doTokenization) {
		if(tokenizer.equals("i2b2")){
			data.add (new LineGroupIterator (new StringReader (i2b2Tokenize(text)),
