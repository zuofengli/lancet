package edu.uwm.jiaoduan.tools.negex;
...
public class GenNegEx {
	...
	public GenNegEx() throws FileNotFoundException {
		String triggersFile		= Messages.getString("negex.trigger.file.path.name");
	...
	public boolean IsNegativeEvent(String sentence, String phrase) throws Exception{
		String afterNegCheck = negCheck(sentence, phrase, rules, false);
