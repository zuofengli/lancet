...
"""
def setSVMPath(splitta_path):
    global SVM_LEARN
    global SVM_CLASSIFY
    
    ## globals
    #WorkSpace = os.getcwd()
    #splitta_path  This would be set my external program
    SVM_LEARN = splitta_path + '/svm_light/svm_learn'
    #for Jython work spacing
    SVM_CLASSIFY = splitta_path + "/svm_light/svm_classify"
...
def load_sbd_model_from_stream(java_stream, model_path):
    model = load_pickle_from_stream(model_path + 'model.pkl')
...
if __name__ == '__main__':
    ...
    SVM_CLASSIFY = WorkSpace + "/svm_light/svm_classify"
    model.classify(test)
